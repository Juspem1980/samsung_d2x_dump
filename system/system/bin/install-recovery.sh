#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/platform/13d60000.ufs/by-name/recovery:67633152:d396103292746063d24a19c7764bac71afe8d1a1; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/platform/13d60000.ufs/by-name/boot:57671680:1dd151a31497b1835a2058dca82050fd5ad0ba2e \
          --target EMMC:/dev/block/platform/13d60000.ufs/by-name/recovery:67633152:d396103292746063d24a19c7764bac71afe8d1a1 && \
